    ...
    render() {
        return (
            <div className={this.state.b+this.state.c>10?'box':''}>
                ...
                <input id="inp" name="a" onKeyDown={this.handleInput} type="text"/>
                +
                <input name="b"  value={this.state.b} onKeyDown={this.handleInput} type="text"/>
                +
                <input name="c"  value={this.state.c} onKeyDown={this.handleInput} type="text"/>
                =
